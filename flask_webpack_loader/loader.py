"""
From:
https://github.com/naivefeeling/flask-webpack-loader/commit/aa6034d00666e949a9829f5c4cdcce6b5bb412b6
"""
import json
import time
from io import open
...
class WebpackLoader(object):
    ...
    def render_entrypoint(self, bundle_name, extension=None, attrs=''):
        """
        Get a list of formatted <script> & <link> tags for the assets in the
        named bundle.
        :param bundle_name: The name of the bundle
        ...
        :return: a list of formatted tags as strings
        """
        entry = self.get_entry(bundle_name)
        tags = []
        for chunk in entry:
            if chunk['name'].endswith(('.js', '.js.gz')):
                tags.append(
